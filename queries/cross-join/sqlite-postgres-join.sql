...
-- Requires catalogs: sr_sqlite_emp (ADBC SQLite driver), sr_postgres (ADBC PostgreSQL driver)
--
-- sr_sqlite_emp.main.employees:    id INTEGER, name TEXT, dept_id INTEGER
...
FROM sr_sqlite_emp.main.employees e
