-- sqlflite TPC-H init: SQLite-compatible schema and seed data
-- Used to build tpch_sqlflite.db for volume mounting into sqlflite container
-- SQLite types: INTEGER, REAL, TEXT (no DECIMAL, no VARCHAR(n), no DATE)
